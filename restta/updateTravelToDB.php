<?php
    ...
    $stmt = $con->prepare("INSERT INTO viatjes(name, firstSurname, secondSurname, salari, position, initialDate, finalDate) VALUES(:field1, :field2, :field3, :field4, :field5, :field6, :field7)");
